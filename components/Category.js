export default function Category() {
  return (
    <div className="flex select-none max-w-lg text-[0.65rem] md:text-sm lg:text-[0.9rem] xl:text-base items-center font-semibold justify-between w-[100%] sm:w-[85%] md:w-[80%] lg:w-[75%] xl:w-[70%]  mx-auto mt-10 mb-4">
