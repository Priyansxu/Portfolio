export default function Category() {
  return (
    <div className="flex select-none max-w-lg text-[11px] sm:text-[13px] items-center font-semibold justify-between gap-1 w-[100%] sm:w-[85%] md:w-[80%] lg:w-[75%] xl:w-[70%] mx-auto mt-10 mb-4">
